export default class ModalContentProvider {
  constructor() {
    this.modalContents = {
      intro: {
        title: 'Introduction',
        description: 'Nice to meet you. I am Gustavo Kang Shim, a Computing Science graduate from TRU.',
      },
      projects: {
        title: 'Projects',
        description: `
        ...
        description: `
          <div class="about-layout">
            <div>
              ...
              <p class="opacity-70">Computing Science Graduate</p>
            </div>
            <div class="about-body">
              <p>I am a recent Computing Science graduate with experience in technical support, systems, and software projects.</p>

              <p>I graduated with a <strong>Bachelor of Computing Science</strong> from <strong>Thompson Rivers University</strong>.</p>

              <p>I have worked on web, data, and cloud projects, and I am open to both IT and software roles.</p>

              <p>I enjoy learning, solving problems, and building useful tools.</p>
              <ul class="about-list">
                <li>Brazil to Canada journey</li>
                <li>Enjoys videogames, gym, soccer</li>
                <li>Interested in IT and software work</li>
              </ul>
            </div>
          </div>
        `,

let Ht, le, he, Re, cr, or, je, mr, ut, oe, T, wr, ze, Mt, ve, Te, _r, fr, Ql, ot, Ye, er, dr, Me, Z, tr, Ke, ar, nt, z, br, et, se, $, sr, lr, pr, _t, bt, xe, Ze, rr, ne, ae, ur, $l, ft, qt, yt, $e, nr, ie, B, Xe, G, g, Fe, Tt, Ce, He, Ie, Ae, ce, F, gt, st, ct, S, de, Qe, ir, yr, hr, Pe, Ee, ge, Se, Ue, h, Vt, eh, th;
let __tla = (async () => {
  const Sr = "" + new URL("rapier_wasm3d_bg-BBqGjUjc.wasm", import.meta.url).href, Rr = async (o = {}, t) => {
    let e;
    if (t.startsWith("data:")) {
      ...
      if ("instantiateStreaming" in WebAssembly && n.startsWith("application/wasm")) e = await WebAssembly.instantiateStreaming(r, o);
      else {
  ...
  function Ge(o, t) {
    return Le.decode(jr().subarray(o, o + t));
  }
  function Ar() {
    try {
      const e = v(-16);
      Yr(e);
      var o = A()[e / 4 + 0], t = A()[e / 4 + 1];
      return Ge(o, t);
    } finally {
      v(16), vt(o, t);
    }
  ...
  let E = 32;
  function x(o) {
    if (E == 1) throw new Error("out of js stack");
    return C[--E] = o, E;
  }
  function De(o, t) {
  ...
  class wt {
    ...
    intersectionsWithRay(t, e, r, n, s, a, l, w, p, u, _, m) {
      try {
        c(t, M), c(e, P), c(r, d), c(n, d), jl(this.ptr, t.ptr, e.ptr, r.ptr, n.ptr, s, a, x(l), w, !f(p), f(p) ? 0 : p, !f(u), f(u) ? 0 : u, !f(_), f(_) ? 0 : _, x(m));
      } finally {
    ...
    intersectionWithShape(t, e, r, n, s, a, l, w, p, u) {
      try {
        const y = v(-16);
        c(t, M), c(e, P), c(r, d), c(n, R), c(s, b), Al(y, this.ptr, t.ptr, e.ptr, r.ptr, n.ptr, s.ptr, a, !f(l), f(l) ? 0 : l, !f(w), f(w) ? 0 : w, !f(p), f(p) ? 0 : p, x(u));
        var _ = A()[y / 4 + 0], m = jt()[y / 8 + 1];
        return _ === 0 ? void 0 : m;
      } finally {
        v(16), C[E++] = void 0;
      }
  ...
  class M {
    ...
    rbIsDynamic(t) {
      return js(this.ptr, t) !== 0;
    }
    rbLinearDamping(t) {
      return As(this.ptr, t);
    }
    rbAngularDamping(t) {
  ...
  function Pr(o, t) {
    const e = j(t), r = typeof e == "number" ? e : void 0;
    jt()[o / 8 + 1] = f(r) ? 0 : r, A()[o / 4 + 0] = !f(r);
  }
  function Mr(o) {
    const t = j(o);
  ...
  function Fr() {
    return we(function(o, t, e) {
      const r = j(o).call(j(t), j(e));
      return H(r);
    }, arguments);
  }
  function kr() {
    return we(function(o, t, e, r) {
      const n = j(o).call(j(t), j(e), j(r));
      return H(n);
    }, arguments);
  }
  function Dr() {
    return we(function(o, t, e, r, n) {
      const s = j(o).call(j(t), j(e), j(r), j(n));
      return H(s);
    }, arguments);
  }
  function Nr(o, t, e, r) {
    const n = j(o).bind(j(t), j(e), j(r));
    return H(n);
  }
  function Lr(o) {
    const t = j(o).buffer;
  ...
  function Gr(o, t, e) {
    const r = new Uint8Array(j(o), t >>> 0, e >>> 0);
    return H(r);
  }
  function Br(o) {
    const t = new Uint8Array(j(o));
    return H(t);
  }
  function Wr(o, t, e) {
    j(o).set(j(t), e >>> 0);
  ...
  function qr(o, t, e) {
    const r = new Float32Array(j(o), t >>> 0, e >>> 0);
    return H(r);
  }
  function Vr(o, t, e) {
    j(o).set(j(t), e >>> 0);
  ...
  lr = class {
    ...
    contactPair(t, e, r) {
      ...
      if (n) {
        ...
        let a;
        for (a = 0; a < n.numContactManifolds(); ++a) this.tempManifold.raw = n.contactManifold(a), this.tempManifold.raw && r(this.tempManifold, s), this.tempManifold.free();
        n.free();
      }
    }
  ...
  F = class {
    static fromRaw(t, e) {
      ...
      switch (r) {
        ...
        case S.Capsule:
          return w = t.coHalfHeight(e), p = t.coRadius(e), new je(w, p);
        case S.Segment:
          return a = t.coVertices(e), new Ae(h.new(a[0], a[1], a[2]), h.new(a[3], a[4], a[5]));
        case S.Polyline:

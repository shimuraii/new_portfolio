const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./App-fS0Hx6k_.js","./App-G1QgzcIs.css"])))=>i.map(i=>d[i]);
import { A as C, _ as g, __tla as __tla_0 } from "./App-fS0Hx6k_.js";
Promise.all([
  (() => {
    try {
      return __tla_0;
  ...
  async function q() {
    ...
    const [{ WebGLRenderer: t, Scene: n, PerspectiveCamera: i, Color: u, sRGBEncoding: _, ACESFilmicToneMapping: M, AmbientLight: A, DirectionalLight: D, Box3: P, Vector3: f }, { GLTFLoader: x }, { DRACOLoader: I }] = await Promise.all([
      g(() => import("./App-fS0Hx6k_.js").then(async (m) => {
        await m.__tla;
        return m;
